...
export class UpazilaComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.upazilaService
      ...
      .subscribe({
        next: (res: HttpResponse<IUpazila[]>) => {
  ...
  trackId(index: number, item: IUpazila): string {
    return item.id!;
  }
  ...
  protected onSuccess(data: IUpazila[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/upazila'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
