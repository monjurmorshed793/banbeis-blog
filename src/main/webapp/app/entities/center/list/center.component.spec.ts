...
describe('Center Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'center', component: CenterComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.centers?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
