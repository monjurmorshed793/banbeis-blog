...
describe('PostPhoto Management Component', () => {
  let comp: PostPhotoComponent;
  let fixture: ComponentFixture<PostPhotoComponent>;
  let service: PostPhotoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'post-photo', component: PostPhotoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PostPhotoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.postPhotos?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
