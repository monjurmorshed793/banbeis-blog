...
export class PostService {
  ...
  protected convertDateFromClient(post: IPost): IPost {
    return Object.assign({}, post, {
      postDate: post.postDate?.isValid() ? post.postDate.format(DATE_FORMAT) : undefined,
      publishedOn: post.publishedOn?.isValid() ? post.publishedOn.toJSON() : undefined,
    });
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.publishedOn = res.body.publishedOn ? dayjs(res.body.publishedOn) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((post: IPost) => {
        post.postDate = post.postDate ? dayjs(post.postDate) : undefined;
        post.publishedOn = post.publishedOn ? dayjs(post.publishedOn) : undefined;
      });
    }
    return res;
  }
